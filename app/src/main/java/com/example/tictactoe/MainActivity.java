...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean checkResults() {
        ...
        for (int i = 0; i < combinationsList.size(); i++) {
            final int[] condition = combinationsList.get(i);
            if (boxPositions[condition[0]] == playerTurn && boxPositions[condition[1]] == playerTurn &&
                    boxPositions[condition[2]] == playerTurn) {
                response = true;
                break;
            }
        }
